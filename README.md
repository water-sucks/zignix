...
You can find the link for these raw C API docs by going to
https://hydra.nixos.org, looking for the Nix job set, and searching for
`external-api-docs` in the built artifacts.
